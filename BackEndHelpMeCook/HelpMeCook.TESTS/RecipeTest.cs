...
public class RecipeTest
{
    ...
    public async void CreateRecipe_ShouldThrowExceptionWhenRecipeNameTaken()
    {
        ...
        recipeRepo.Setup(r => r.GetByRecipeNameAndUserID(It.IsAny<string>(), It.IsAny<string>())).ReturnsAsync(recipe);
    ...
    public async void CreateRecipe_ShouldThrowExceptionWhenRecipeNumberRegistered()
    {
        ...
        recipeRepo.Setup(r => r.GetByRecipeNumberAndUserID(It.IsAny<int>(), It.IsAny<string>())).ReturnsAsync(recipe);
